Feature: Demoblaze cart persistence
  ...
  So that I can continue shopping without losing items
        ...
        Scenario: Product remains in cart after navigating through the site
             When I add the product "Samsung galaxy s6" for persistence validation
              And I navigate back to the home page for persistence validation
              And I open the cart page for persistence validation
